    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
                    ...
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <li class="user-footer">
                                <a href="{{ route('change-password') }}" class="btn btn-default btn-flat">Update Password</a>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2023 <a href="http://just-dive.in/">just-dive.in</a>.</strong> All rights
                reserved.
            </footer>
        </div>
    </body>
